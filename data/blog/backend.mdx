...
<<<<<<< HEAD
with [git](https://git-scm.com/) – that's what [this blog](https://github.com/dgsmonteiro/douglasmonteiro.dev.br) uses.
=======
...
```bash
<<<<<<< HEAD
$ curl https://douglasmonteiro.dev.br/api/page-views?id=databases
=======
