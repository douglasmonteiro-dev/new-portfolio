...
with [git](https://git-scm.com/) – that's what [this blog](https://github.com/dgsmonteiro/douglasmonteiro.dev) uses.
...
```bash
$ curl https://douglasmonteiro.dev/api/page-views?id=databases
