...
<<<<<<< HEAD
The structure of the data export appears to be consistent, so I made a Python script to parse and aggregate the statistics mentioned in this post using [BeautifulSoup](https://pypi.python.org/pypi/beautifulsoup4) to traverse the DOM of the HTML files. To use this script on your own Facebook data dump, first [export your data](https://www.facebook.com/help/131112897028467) and then go to my [GitHub repo](https://github.com/dgsmonteiro/facebook-data-analyzer) and download the `facebook.py` file. From there, you should place this file in the same folder as your Facebook data dump. To run the script, open the terminal and enter:
=======
